...
const BASE_LAYOUT = Object.freeze({
  ...
  gathering: {
    ...
    zones: [
      { id: "arrival-west", minX: -15, maxX: -8, minZ: 6, maxZ: 19 },
      { id: "arrival-east", minX: 10, maxX: 18, minZ: 4, maxZ: 18 },
      { id: "slope-west", minX: -17, maxX: -10, minZ: -16, maxZ: 4 },
      { id: "slope-east", minX: 10, maxX: 18, minZ: -16, maxZ: 2 },
      { id: "market-west", minX: -19, maxX: -12, minZ: -34, maxZ: -18 },
      { id: "market-east", minX: 13, maxX: 21, minZ: -35, maxZ: -18 },
    ],
  },
  generalMine: {
