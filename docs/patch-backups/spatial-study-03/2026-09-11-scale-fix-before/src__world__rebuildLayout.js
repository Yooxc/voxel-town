...
export function getRebuildTerrainHeight(x, z, origin = { x: 0, y: 0, z: 0 }) {
  ...
  return origin.y + arrivalHill + Math.max(distantEastRise, distantNorthRise);
}
...
const BASE_LAYOUT = Object.freeze({
  ...
  generalMine: {
    ...
    center: { x: -101, y: QUARRY_FLOOR_HEIGHT, z: -40 },
    pathPoints: [
      { x: -28, y: 0.3, z: -12 },
      { x: -31, y: 1, z: -24 },
      { x: -41, y: 1.8, z: -35 },
    ...
    floorPolygon: [
      { x: -112, z: -45 }, { x: -106, z: -51 }, { x: -96, z: -52 },
      { x: -87, z: -48 }, { x: -83, z: -42 }, { x: -85, z: -34 },
      { x: -91, z: -29 }, { x: -104, z: -29 }, { x: -112, z: -35 },
    ],
    rockBounds: { minX: -110, maxX: -86, minZ: -49, maxZ: -31 },
    resourceArea: {
      polygon: [
        { x: -109, z: -44.5 }, { x: -104.5, z: -48.5 }, { x: -96, z: -49.5 },
        { x: -88, z: -46 }, { x: -85.8, z: -41 }, { x: -88, z: -35 },
        { x: -93, z: -31.5 }, { x: -103.5, z: -31.5 }, { x: -109, z: -36 },
      ],
      exclusions: [
        { id: "quarry-entrance", type: "capsule", ax: -94, az: -39, bx: -85, bz: -39, radius: 2.8 },
        { id: "quarry-facility", type: "box", x: -105.5, z: -47, halfWidth: 3.2, halfDepth: 1.8 },
        { id: "central-rubble-a", type: "circle", x: -101, z: -39.5, radius: 4.1 },
        { id: "central-rubble-b", type: "circle", x: -95, z: -42, radius: 3.1 },
      ],
    },
    visitArea: { type: "polygon", polygon: [
      { x: -112, z: -45 }, { x: -106, z: -51 }, { x: -96, z: -52 },
      { x: -87, z: -48 }, { x: -83, z: -42 }, { x: -85, z: -34 },
      { x: -91, z: -29 }, { x: -104, z: -29 }, { x: -112, z: -35 },
    ] },
    rubbleClusters: [
      { id: "central-a", x: -101, z: -39.5, radius: 3.8, count: 8, scale: 1.8 },
      { id: "central-b", x: -95, z: -42, radius: 2.8, count: 6, scale: 1.45 },
      { id: "north-west", x: -106.5, z: -33, radius: 2.4, count: 5, scale: 1.35 },
      { id: "south-east", x: -89.5, z: -46, radius: 2.2, count: 5, scale: 1.3 },
    ],
    terraces: [
      { x: -111, z: -40, width: 5, depth: 16, height: 5.8, rotationY: -0.08 },
      { x: -103, z: -50, width: 14, depth: 4.5, height: 4.5, rotationY: 0.08 },
      { x: -96, z: -29.5, width: 17, depth: 4.5, height: 4, rotationY: -0.04 },
      { x: -86, z: -34.5, width: 5, depth: 8, height: 3.2, rotationY: 0.18 },
    ],
    facility: { x: -105.5, y: QUARRY_FLOOR_HEIGHT, z: -47 },
    initialRocks: [
      { x: -107, y: QUARRY_FLOOR_HEIGHT, z: -43, sizeIndex: 1 },
      { x: -104, y: QUARRY_FLOOR_HEIGHT, z: -34, sizeIndex: 0 },
      { x: -99, y: QUARRY_FLOOR_HEIGHT, z: -47, sizeIndex: 2 },
      { x: -93, y: QUARRY_FLOOR_HEIGHT, z: -34, sizeIndex: 1 },
      { x: -89, y: QUARRY_FLOOR_HEIGHT, z: -43, sizeIndex: 0 },
      { x: -107, y: QUARRY_FLOOR_HEIGHT, z: -37, sizeIndex: 1 },
    ],
  },
  market: {
    stalls: [
  ...
  expansionAnchors: {
    f1: { x: 35, y: 0, z: -6 },
    f2: { x: -108, y: QUARRY_FLOOR_HEIGHT, z: -60 },
  },
  ridge: {
    segments: [
...
export function getRebuildLayout(startX = 0, startZ = 0, startFlatY = 0) {
  ...
  const quarryResourcePolygon = BASE_LAYOUT.generalMine.resourceArea.polygon.map((point) => offsetXZ(point, startX, startZ));
  ...
  return {
    ...
    generalMine: {
      ...
      resourceArea: {
        ...
        exclusions: BASE_LAYOUT.generalMine.resourceArea.exclusions.map((entry) => offsetExclusion(entry, startX, startZ)),
      },
      ...
      terraces: BASE_LAYOUT.generalMine.terraces.map((terrace) => ({
        ...offsetPosition(terrace, startX, startZ, startFlatY),
        width: terrace.width,
