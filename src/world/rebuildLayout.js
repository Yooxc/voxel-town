...
const BASE_LAYOUT = Object.freeze({
  ...
  market: {
    stalls: [
      {
        id: "materials", x: -8.516209, y: 0, z: -16.315528, accentColor: 0xc49a61,
        displayItems: [
      ...
      {
        id: "craft", x: -0.510673, y: 0, z: -18.611244, accentColor: 0x6c8c9d,
        displayItems: [
          {
      ...
      {
        id: "living", x: 8.184659, y: 0, z: -16.127342, accentColor: 0x9d7664,
        displayItems: [
    ...
    residents: [
      {
        ...
        x: -5.434783, y: 0, z: -15.259216, rotationY: -0.4, color: 0x727e6a,
      ...
      },
      {
        ...
        x: 0.772082, y: 0, z: -16.734668, rotationY: 2.6, color: 0x7b687f,
      ...
      },
      {
        ...
        x: 11.472967, y: 0, z: -16.915013, rotationY: -1.8, color: 0x766850,
...
export function getRebuildLayout(startX = 0, startZ = 0, startFlatY = 0) {
  ...
  return {
    ...
    workArea: {
      stall: offsetPosition(BASE_LAYOUT.market.stalls.find((stall) => stall.id === "materials"), startX, startZ, startFlatY),
    ...
    perimeter: {
      // The one opening joins the existing locked north gate; F1/F2 remain reserved anchors.
      openingEdge: 6,
      outline: [[-166, -60], [-152, -78], [-118, -82], [-86, -65], [-57, -52], [-23, -42],
        [-5, -48], [5, -48], [29, -42], [47, -28], [52, 4], [43, 32], [20, 43],
        [-10, 45], [-33, 38], [-56, 20], [-89, 8], [-129, -6], [-157, -21]]
        .map(([x, z]) => ({ x: x + startX, z: z + startZ })),
      safetyBounds: { minX: startX - 185, maxX: startX + 70, minZ: startZ - 102, maxZ: startZ + 63 },
    },
    navigationObstacles: [
      ...BASE_LAYOUT.market.stalls.map((stall, index) => ({
        id: `market-stall-${index + 1}`, type: "box",
        x: stall.x + startX, z: stall.z + startZ, halfWidth: 1.7, halfDepth: 0.58,
      })),
      ...BASE_LAYOUT.market.residents.map((resident, index) => ({
        id: `market-resident-${index + 1}`, type: "circle",
        x: resident.x + startX, z: resident.z + startZ, radius: 0.55,
      })),
